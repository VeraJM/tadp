...
describe 'test del framework' do
  ...
  it 'pruebo el deberia ser' do
    ...
    expect( lista_resultados.select{ |resultado| resultado.paso?}.count ).to eq(2)
  ...
  it 'pruebo las condiciones menor, mayor y uno_de_estos' do
    ...
    expect( lista_resultados.select{ |resultado| resultado.paso?}.count ).to eq(5)
    expect( lista_resultados.select{ |resultado| resultado.fallo?}.count ).to eq(6)
  end
  ...
  it 'ejecuto todos los test cargados' do
    ...
    expect( lista_resultados.select{ |resultado| resultado.paso?}.count ).to eq(10)
    expect( lista_resultados.select{ |resultado| resultado.fallo?}.count ).to eq(9)
  end
  ...
  it 'ejecuto test especifico' do
    ...
    expect( lista_resultados.select{ |resultado| resultado.paso?}.count ).to eq(2)
    expect( lista_resultados.select{ |resultado| resultado.fallo?}.count ).to eq(0)
  end
  ...
  it 'deberia explotar con' do
    ...
    expect( lista_resultados.select{ |resultado| resultado.paso?}.count ).to eq(3)
